  ...
  async execute(client, interaction) {
    try {
      if (interaction.isChatInputCommand()) {
        ...
        console.log(`[DEBUG] Commands loaded: ${Array.from(client.commands.keys()).join(', ')}`);
        ...
        console.log(`[INFO] Successfully executed command: ${interaction.commandName}`);
        ...
        console.log(`[DEBUG] User context menu received: ${interaction.commandName}`);
        ...
        console.log(`[DEBUG] Message context menu received: ${interaction.commandName}`);
